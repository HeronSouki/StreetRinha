...
const SFX = {
  ...
  zip: (S, t) => { S.noise(t, { dur: 0.08, f: 6000, fTo: 1500, q: 2, vol: 0.3 }); S.tone(t, { f: 2200, slide: 800, dur: 0.06, type: 'p25', vol: 0.08 }); },
  clash: (S, t, p) => { const v = p.v || 1; S.noise(t, { dur: 0.04, ft: 'bandpass', f: 2600, q: 0.8, vol: 0.4 * v, r: 0.06 }); S.tone(t, { f: 260 + rnd(Math.floor(t * 97), 3) * 120, slide: 90, dur: 0.05, type: 'square', vol: 0.16 * v }); DRUM.k(S, t, 0.5 * v); },
  crash: (S, t) => { SFX.explode(S, t, {}); SFX.thud(S, t, {}); },
